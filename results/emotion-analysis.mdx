...
Divergent moments are marked on the timeline so you can jump straight to them and watch for yourself.

## Where it shows up

- **Summary** — the emotional signal section shows the emotion distribution for each moment in your guide, so you can see which topics sparked which reactions. Click into a moment to see the participant timeline and the evidence behind a reading.
...
- **Supercuts** — each reel carries an emotion badge, and the player shows an emotion strip synced to playback.
