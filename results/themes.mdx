---
title: Themes
description: Patterns across all your sessions with supporting quotes, counts, and segment attribution.
---
...
- **Quotes** — direct quotes, attributed by segment and age ("Lapsed user, 38") or participant number, never by name
